import { a as heroCopy, r as companyStory, s as industries } from "./company-DmUVCXMZ.js";
...
import { n as SecondaryButton, t as PrimaryButton } from "./Buttons-D-TltuVc.js";
import { t as ContactCTA } from "./ContactCTA-BijcgTID.js";
import { a as GalleryGrid, i as GalleryLightbox, t as featuredGallery } from "./gallery-BWQQtmxV.js";
import { i as ProjectCard, n as featuredProjects } from "./projects-CADuQ7Yb.js";
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: companyStory.map((p) => /* @__PURE__ */ jsx("p", { children: p }, p.slice(0, 24)))
					}),
					/* @__PURE__ */ jsxs(Link, {
						to: "/about",
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: services.map((s) => /* @__PURE__ */ jsx(ServiceCard, { service: s }, s.slug))
					}),
					/* @__PURE__ */ jsx("div", {
						className: "mt-10",
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(SectionHeading, {
					...
					children: ["All Projects ", /* @__PURE__ */ jsx(ArrowRight, {
						className: "h-4 w-4",
						"aria-hidden": "true"
					})]
				})]
				...
				children: featuredProjects.map((p, i) => /* @__PURE__ */ jsx(ProjectCard, {
					project: p,
					onSelect: setActive,
					priority: i < 3
				}, p.slug))
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(OrganizationChart, { compact: true }), /* @__PURE__ */ jsxs(Link, {
					to: "/about",
					hash: "structure",
		...
		lightbox !== null && /* @__PURE__ */ jsx(GalleryLightbox, {
			images: featuredGallery,
			index: lightbox,
