import { _ as specializations, g as sections, l as introduction, p as ongoingProjects, r as completedProjects, t as company } from "./site-Bt6eg8XZ.js";
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Link, {
							...
							children: ["Our story ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
						}), /* @__PURE__ */ jsx(Link, {
							to: "/projects",
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
					...
					children: [introduction.map((p) => /* @__PURE__ */ jsx("p", { children: p }, p.slice(0, 24))), /* @__PURE__ */ jsxs(Link, {
						to: "/company",
						className: "inline-flex items-center gap-2 pt-2 text-sm font-semibold text-foreground hover:text-primary",
						children: ["Company information ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
					})]
				})]
			})
		}),
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
					...
					children: ["All specializations ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
				})]
			}), /* @__PURE__ */ jsx("ul", {
				className: "mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3",
				children: specializations.map((s) => /* @__PURE__ */ jsx("li", {
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
					...
					to: "/contact",
					className: "inline-flex items-center gap-2 bg-primary px-6 py-3 text-xs font-bold uppercase tracking-[0.16em] text-primary-foreground transition-opacity hover:opacity-90",
					children: ["Contact us ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
				})]
			})
		})
	] });
