...
//#region src/components/GalleryGrid.tsx
function GalleryGrid({ images, onSelect, eagerCount = 3 }) {
	return /* @__PURE__ */ jsx("ul", {
		className: "grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3",
		children: images.map((image, i) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
			type: "button",
			onClick: () => onSelect(i),
...
//#endregion
//#region src/components/GalleryLightbox.tsx
function GalleryLightbox({ images, index, onClose, onIndexChange }) {
	const closeRef = useRef(null);
	const image = images[index];
	const next = useCallback(() => onIndexChange((index + 1) % images.length), [
		index,
		images.length,
		onIndexChange
	]);
	const prev = useCallback(() => onIndexChange((index - 1 + images.length) % images.length), [
		index,
		images.length,
		onIndexChange
	]);
...
//#endregion
export { GalleryGrid as a, GalleryLightbox as i, galleryCategories as n, galleryImages as r, featuredGallery as t };
