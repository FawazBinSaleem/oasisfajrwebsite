...
export const services: Service[] = [
  {
    ...
    icon: Building2,
    short:
      "Construction, renovation, structural, and infrastructure works for commercial and industrial projects.",
    overview:
      "We execute concrete and steel structures, renovation and infrastructure works for commercial, industrial, sports and residential buildings, including demolition, earth moving, pavement and external works.",
    scope: [
      "Structural works",
      "Renovation",
      "Masonry",
